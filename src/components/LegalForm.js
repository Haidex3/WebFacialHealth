    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <h2 style={{ color: 'white' }}>1. Aceptación de los Términos</h2>
                <p>
                ...
                <h2 style={{ color: 'white' }}>2. Uso de la Aplicación</h2>
                <p>
                ...
                <h2 style={{ color: 'white' }}>3. Registro y Seguridad</h2>
                <p>
                ...
                <h2 style={{ color: 'white' }}>4. Privacidad y Protección de Datos</h2>
                <p>
                ...
                <h2 style={{ color: 'white' }}>5. Propiedad Intelectual</h2>
                <p>
                ...
                <h2 style={{ color: 'white' }}>6. Limitación de Responsabilidad</h2>
                <p>
                ...
                <h2 style={{ color: 'white' }}>7. Modificaciones de los Términos</h2>
                <p>
                ...
                <h2 style={{ color: 'white' }}>8. Ley Aplicable y Jurisdicción</h2>
                <p>
